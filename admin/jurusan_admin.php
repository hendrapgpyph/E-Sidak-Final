...
<!--Welcome-->
        ...
        <div class="container container-button-cetak">
          <div class="col-md-12">
            ...
            <button type="button" name="button" class="btn btn-cw">
              <a href="../config/word_kelas.php"><i class="fa fa-file-word-o"></i>&nbsp;Cetak Word</a>
            </button>
            <button type="button" name="button" class="btn btn-ce">
            <a href="../config/excel_kelas.php"><i class="fa fa-file-excel-o"></i>&nbsp;Cetak Excel</a>
          </button>
          </div>
        ...
        <div class="container">
            <table class="table table-striped database">
              <thead>
                <tr>
                  <th>Id Jurusan</th><th>Nama Jurusan</th><th>Singkatan Jurusan</th><th>Jml Index Kls X</th><th>Jml Index Kls XI</th><th>Jml Index Kls XII</th><th>Action</th>
                </tr>
              </thead>
            <tbody>
              <?php
            ...
            while($tampil = mysqli_fetch_array($sqll)){
              ...
              <tr>
                ...
                <td>
                    <a href="update_jurusan.php?id=<?php echo $tampil['id_jurusan'];?>">
                        <button class="btn btn-warning" type="button">
                            <i class="fa fa-edit" aria-hidden="true"></i>
                        </button>
                     </a>
                    <a href="../config/delete_jurusan.php?id=<?php echo $tampil['id_jurusan'];?>">
                        <button class="btn btn-warning" type="button">
