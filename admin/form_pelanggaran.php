...
<nav class="navbar navbar-default navbar-custom">
    ...
    <div class="container-fluid">
         <div class="jumbotron-list">
           <h2 class="text-center">TAMBAH PELANGGARAN</h2>
       </div>
     </div>
...
<!--Welcome-->
      ...
      <div class="col-md-12">
        <div class="form-content tambah">
          <form action="../config/daftar_langgar.php" method="post">
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" name="min_poin" min="5" max="90" required>
              </div>
