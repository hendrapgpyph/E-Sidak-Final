...
<nav class="navbar navbar-default navbar-custom">
    ...
    <div class="container-fluid">
         <div class="jumbotron-list">
           <h2 class="text-center">UPDATE JURUSAN</h2>
       </div>
     </div>
 ...
 <?php
  include ("../config/koneksi.php");
  $id=$_GET['id'];
  $query=mysqli_query($con,"SELECT * FROM jurusan where id_jurusan='$id'");
    ...
    <div class="container-fluid">
      <div class="col-md-12">
        <div class="form-content tambah">
          <form action="../config/update_jurusan.php?id=<?php echo $row['id_jurusan'];?>" method="post">

              <div class="form-group">
                <label>Nama Jurusan</label>
                <input type="text" class="form-control" name="nama_jurusan" value="<?php echo $row['nama_jurusan'];?>">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" name="x" value="<?php echo $row['indeks_x'];?>">
              </div>
              <div class="form-group">
                <label>Jumlah Indeks Kelas XI</label>
                <input type="number" class="form-control" name="xi" value="<?php echo $row['indeks_xi'];?>">
              </div>
              <div class="form-group">
                <label>Jumlah Indeks Kelas XII</label>
                <input type="number" class="form-control" name="xii" value="<?php echo $row['indeks_xii'];?>">
              </div>
