...
<nav class="navbar navbar-default navbar-custom">
    ...
    <div class="container-fluid">
        <div class="jumbotron-list">
          <h2 class="text-center">UPDATE PELANGGARAN</h2>
      </div>
    </div>
 ...
 <?php
  include ("../config/koneksi.php");
  $id=$_GET['id'];
  $query=mysqli_query($con,"SELECT * FROM pelanggaran where id_pelanggaran='$id'");
    ...
    <div class="container-fluid">
      <div class="col-md-12">
        <div class="form-content tambah">
          <form action="../config/update_pelanggaran.php?id=<?php echo $row['id_pelanggaran'];?>" method="post">

              <div class="form-group">
                <label>Nama Pelanggaran</label>
                <input type="text" class="form-control" name="nama_pelanggaran" value="<?php echo $row['nama_pelanggaran'];?>" required>
              </div>
              <div class="form-group">
                <label>Min Poin</label>
                <input type="number" class="form-control" name="min_poin" value="<?php echo $row['min_poin'];?>" min="5" max="90" required>
              </div>
          ...
          <a href="pelanggaran_admin.php" class="btn-back"><i class="fa fa-arrow-left"></i></a>
      </div>
    </div>
