         ...
         <div id="myModal" class="modal <?php echo $tampill['singkatan'] ?>">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <h4><li class="list-group-item text-center"><a href="sidak.php?kelas=12&indeks=1&id=<?php echo $tampill['id_jurusan']; ?>"><?php echo $tampill['nama_jurusan']; ?> 1</a></li></h4>
                <h4><li class="list-group-item text-center"><a href="sidak.php?kelas=12&indeks=2&id=<?php echo $tampill['id_jurusan']; ?>"><?php echo $tampill['nama_jurusan']; ?> 2</a></li></h4>
              </div>
            </div><!-- modal-content -->
          </div>
          <?php
        }else if ($tampill['indeks_xii']=='3') {
          ?>
           <div id="myModal" class="modal <?php echo $tampill['singkatan'] ?>">
            <div class="modal-content">
              <div class="modal-header">
              ...
              <div class="modal-body">
                <h4><li class="list-group-item text-center"><a href="sidak.php?kelas=12&indeks=1&id=<?php echo $tampill['id_jurusan']; ?>"><?php echo $tampill['nama_jurusan']; ?> 1</a></li></h4>
                <h4><li class="list-group-item text-center"><a href="sidak.php?kelas=12&indeks=2&id=<?php echo $tampill['id_jurusan']; ?>"><?php echo $tampill['nama_jurusan']; ?> 2</a></li></h4>
                <h4><li class="list-group-item text-center"><a href="sidak.php?kelas=12&indeks=3&id=<?php echo $tampill['id_jurusan']; ?>"><?php echo $tampill['nama_jurusan']; ?> 3</a></li></h4>
              </div>
            </div><!-- modal-content -->
          </div>
          <?php
